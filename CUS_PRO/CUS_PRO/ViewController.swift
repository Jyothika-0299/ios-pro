...
class ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBAction func ClickSave(_ sender: Any) {
       ...
       let accessToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..oDiC-aM-hYtKDbqI8CP_J-KZqYt9nJPgJhuib0dtFZw"
        ...
        guard let webserviceURL = URL(string: "https://abzcustomerwebapi-chanad.azurewebsites.net/api/Customer/\(accessToken)") else {
    ...
    @IBAction func ClickUpdate(_ sender: Any) {
        ...
        guard let webserviceURL = URL(string: "https://abzcustomerwebapi-chanad.azurewebsites.net/api/Customer/\(ID)") else {
            showAlert(title: "Error", message: "Invalid URL")
            return
        }
    ...
    @IBAction func ClickGet(_ sender: UIButton) {
        let accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..oDiC-aM-hYtKDbqI8CP_J-KZqYt9nJPgJhuib0dtFZw"  // Make sure this is the correct token
